...
class Captcha
{
    ...
    public function check(string $key, string $code): bool
    {
        ...
        $res = password_verify($code, $value);
    ...
    public function create(string $config = null, bool $api = false)
    {
        ...
        $type = getimagesizefromstring($content)['mime'];
        $base64String = 'data:' . $type . ';base64,' . base64_encode($content);
        return [
            'key' => $generator['key'],
            'img' => $base64String,
        ];
